...
public:
     ...
     * @param data Filled patch container with computed patch and vertex colors.
     */
	static void visualize(const char * setTitle, const RadiosityEngine &randerEngine, bool bSaveScreen = false);
...
private:
	...
	static const RadiosityEngine *m_engine;
