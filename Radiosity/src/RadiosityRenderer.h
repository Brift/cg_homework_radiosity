...
public:
     ...
     */
    RadiosityRenderer(TriangleSet &tSet, float formFactorTreshold, long maxCacheSize);
    ~RadiosityRenderer();
     ...
     */
	void computeNStep(int stepCount);
	void computeOneStep();
...
private:
    ...
    void normalize(Color &dest) {	//归一化到0-1之间
